...
class Conv_residual_conv(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, act_fn):
        ...
        self.conv_1 = dirac_conv_block(self.in_dim, self.out_dim, act_fn)
        self.conv_2 = dirac_conv_block_3(self.out_dim, self.out_dim, act_fn)
        self.conv_3 = dirac_conv_block(self.out_dim, self.out_dim, act_fn)
...
class UDNetGenerator(nn.Module):

    def __init__(self, input_nc, output_nc, ngf):
        super(UDNetGenerator, self).__init__()
        ...
        self.out = DiracConv2d(self.out_dim, self.final_out_dim, kernel_size=3, padding=1)
